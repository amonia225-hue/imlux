            ...
            <aside class="sidebar" id="sidebarMenu">
                ...
                <nav class="nav">
                    ...
                    @php
                        ...
                        $depotsAExaminer = \App\Models\SoumissionPromoteur::where('statut', 'soumise')->count();
                    @endphp
                    <a class="nav-item" href="{{ route('admin.collecte.index') }}">🏢 Collecte promoteurs @if($depotsAExaminer)<span style="background:var(--danger);color:#fff;border-radius:999px;padding:1px 7px;font-size:.7rem;margin-left:4px">{{ $depotsAExaminer }}</span>@endif</a>
